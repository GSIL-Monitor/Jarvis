_This is my summary of the Effective Java 2nd Edition by Joshua Bloch. I use it while learning and as quick com.mrliuxia.jarvis.reference. It is not intended to be an standalone substitution of the book so if you really want to learn the concepts here presented, buy and read the book and use this repository as a com.mrliuxia.jarvis.reference and guide._
...
- [6. ENUMS AND ANNOTATIONS](#6-enums-and-annotations)
	...
	- [36. Consistently use the _Override_ com.mrliuxia.jarvis.annotation](#36-consistently-use-the-override-annotation)
...
* If providing only static com.mrliuxia.jarvis.factory methods, classes without public or protected constructors cannot be subclassed (encourage to use composition instead inheritance).
...
* Group static methods, including com.mrliuxia.jarvis.factory methods, for objects that implement a particular interface.
...
**_Use static com.mrliuxia.jarvis.factory methods in preference to constructors [Item 1](#1-use-static-factory-methods-instead-of-constructors)_**
...
If the stack grows and shrinks the objects popped will not be garbage collected. The stack maintains obsolete references (a com.mrliuxia.jarvis.reference that will never be dereferenced).
...
* You don't care whether the class provides a "logical equality" test. I.e. _java.com.mrliuxia.jarvis.util.Random_
...
1. Use the == operator to check if the argument is a com.mrliuxia.jarvis.reference to this object (for performance)
...
2. For each field _f_ used in _equals_ do:
  * Compute _c_
    ...
    *	object com.mrliuxia.jarvis.reference: if _equals_ of the com.mrliuxia.jarvis.reference use recutsivity, use recursivity for the _hashCode_
...
Static fields can be public if contain primitive values or references to immutable objects. A final field containing a com.mrliuxia.jarvis.reference to a mutable object has all the disadvantages of a non final field.
...
2. Make all of its constructors private or package-private and add a public static com.mrliuxia.jarvis.factory
...
To allow programmers to write efficient subclasses without undue pain, a class may have to provide hooks into its internal com.mrliuxia.jarvis.working in the form of judiciously chosen protected methods.
...
_simple implementation_ is like a skeletal implementation in that it implements the simplest possible com.mrliuxia.jarvis.working implementation.
...
A host class can export the a public static field or com.mrliuxia.jarvis.factory, whose type is the interface and the concrete strategy class is a private nested class.
...
Eliminate every unchecked warning that you can, if you can´t use _Suppress-Warnings_ com.mrliuxia.jarvis.annotation on the smallest scope possible.
...
To avoid ic create a _generic static com.mrliuxia.jarvis.factory method_
...
```java
	...
	com.mrliuxia.jarvis.fcom.mrliuxia.jarvis.factory	private static UnaryFunction<Object> IDENTITY_FUNCTION = new UnaryFunction<Object>(){
...
Sample of the _@Test_ com.mrliuxia.jarvis.annotation

**Marker**
```java

	//Marker com.mrliuxia.jarvis.annotation type declaration
	import java.lang.com.mrliuxia.jarvis.annotation.*;
...
`@Retention(RetentionPolicy.RUNTIME)`: indicates that the Test com.mrliuxia.jarvis.annotation should be retained at runtime.(It makes them visible to the test tool)
...
| TYPE            | class, interface, com.mrliuxia.jarvis.annotation and enums declaration |
...
```java
	...
	import java.lang.reflect.*com.mrliuxia.jarvis.reflectic class RunTests{
...
## 36. Consistently use the _Override_ com.mrliuxia.jarvis.annotation
Use the _Override_ com.mrliuxia.jarvis.annotation on every method declaration that you believe to override a super class declaration.
...
* It's possible to add more information to an com.mrliuxia.jarvis.annotation type after it is already in use.
...
* java.lang
* java.util
* jacom.mrliuxia.jarvis.utilo
* java.util.conccom.mrliuxia.jarvis.utilnt  
...
```
**effectively immutable**: data object  modified by one thread to modify shared it with other threads, synchronizing only the act of sharing the object referencecom.mrliuxia.jarvis.referencehreads can then read the object without further synchronization, so long as it isn't modified again.

**safe publication**: Transferring such an object referencecom.mrliuxia.jarvis.reference thread to others.
...
* For classes with object referencecom.mrliuxia.jarvis.referencehat must remain private, defensively copy each object in such a field. Mutable components of immutable classes fall into this category.
...
To prevent attacks when using _readResolve_ for instance control, all instance fields with object referencecom.mrliuxia.jarvis.referencest be declared transient.
