...
/**
 * Description:建造者模式
 * 实例：我们假设一个快餐店的商业案例，其中，一个典型的套餐可以是一个汉堡（Burger）和一杯冷饮（Cold drink）。
 ...
 * Date: 2018/3/30
 */
public class HelloBuilderDP {

    public static void main(String[] args) {
        OrderBuilder.Order vegetableOrder = OrderBuilder.prepareVegetableOrder();
        vegetableOrder.printOrder();
        vegetableOrder.printCost();

        OrderBuilder.Order meatOrder = OrderBuilder.prepareMeatOrder();
        meatOrder.printOrder();
        meatOrder.printCost();
