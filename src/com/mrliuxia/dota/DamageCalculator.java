package com.mrliuxia.dota;

import com.mrliuxia.dota.base.Hero;
import com.mrliuxia.dota.base.HeroData;
...
public class DamageCalculator {
    ...
    public static void main(String[] args) {
        ...
        Hero tiny = new Hero(JsonUtil.fromJson(FileUtil.readFromFile("src/com.mrliuxia.jarvis.dota/data/hero_tiny.json"), HeroData.class));
